...
blockchain-app-registry:
    image: klayr/service_blockchain_app_registry:0.7.0
    ...

  blockchain-connector:
    image: klayr/service_blockchain_connector:0.7.0
    ...

  blockchain-indexer:
    image: klayr/service_blockchain_indexer:0.7.0
    ...

  blockchain-coordinator:
    image: klayr/service_blockchain_coordinator:0.7.0
    ...

  transaction-statistics:
    image: klayr/service_transaction_statistics:0.7.0
    ...

  fee-estimator:
    image: klayr/service_fee_estimator:0.7.0
    ...

  gateway:
    image: klayr/service_gateway:0.7.0
    ...

  market:
    image: klayr/service_market:0.7.0
    ...

  export:
    image: klayr/service_export:0.7.0
