...
:url_config_file: https://github.com/KlayrHQ/klayr-service/blob/release/0.7.0/ecosystem.config.js
...
| https://geoip.klayr.com/json[GeoIP Server's URL^]
...
| https://downloads.klayr.com/klayr/mainnet/genesis_block.json.tar.gz[Genesis block URL^]
...
By default, it is set to `klayr_mainchain`.
| klayr_mainchain
