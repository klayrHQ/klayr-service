...
// :url_http_api: https://github.com/klayrhq/klayr-service/blob/v0.7.8/docs/api/version3.md
:url_http_api: {klayr-docs}api/klayr-service-http.adoc
:url_websocket_api: https://github.com/KlayrHQ/klayr-service/blob/v0.7.8/docs/api/version3.md
:url_subscribe_api: https://github.com/KlayrHQ/klayr-service/blob/v0.7.8/docs/api/websocket_subscribe_api.md
