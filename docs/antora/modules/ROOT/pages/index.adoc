...
:url_rpc_api_testnet: wss://testnet-service.klayr.com/rpc-v3
:url_subscribe_api_mainnet: wss://service.klayr.com/blockchain
...
// :url_http_api: https://github.com/KlayrHQ/klayr-service/blob/v0.7.0-rc.2/docs/api/version3.md
:url_http_api: {klayr-docs}api/klayr-service-http.adoc
:url_websocket_api: https://github.com/KlayrHQ/klayr-service/blob/v0.7.0-rc.2/docs/api/version3.md
:url_subscribe_api: https://github.com/KlayrHQ/klayr-service/blob/v0.7.0-rc.2/docs/api/websocket_subscribe_api.md
...
* https://service.klayr.com/api/v3/transactions
* https://testnet-service.klayr.com/api/v3/transactions
====
...
//const WS_RPC_ENDPOINT = "wss://service.klayr.com/rpc-v3";
